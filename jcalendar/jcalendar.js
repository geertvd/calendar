if (Drupal.jsEnabled) {
  $(document).ready(function() {
    ...
    $('a.popup').click(function(a) {
      ...
      var div = $('<div id="calpopup"><div><img id="popup-close-img" src="' + var_path + '/images/cross.png" /></div><div id="calpopup-body"><img src="' + var_path + '/images/throbber.gif" id="popthrobber" /></div><div id="nodelink"><a href="' + $(this).attr('href') + '">Click for full page</a></div></div>').attr('style','display: none');
